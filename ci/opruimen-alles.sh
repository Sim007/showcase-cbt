...
# op de hoofdmap en niet in een scenariomap, want beide scenario's gebruiken hem.
...
# scenario 0 een bereikbaar-maar-leeg register aan — en dat is een derde toestand die
