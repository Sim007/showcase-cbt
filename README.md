...
```sh
ci/bouw-stubbundel.sh showcase-cbt scenario-api 0.12.0 run-stream 0.11.0 0.14.0
```

Levert `build/stubbundel-0.14.0.tgz` op, ongeveer 300 KB. De drie versies staan er los in:
